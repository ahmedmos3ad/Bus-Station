...
public class AdminCheckBookings {
	...
	private void initialize() {
		setFrame(new JFrame());
		getFrame().setBounds(100, 100, 418, 429);
		...
		textField_6.setBounds(10, 276, 368, 29);
		...
		textField_7.setBounds(10, 316, 368, 29);
		...
		textField_8.setBounds(10, 356, 368, 29);
	...
	for(j=0;j<=i;j++) {
			...
			if (z==6)
				textField_6.setText(CurrentBookings[j][0]+","+CurrentBookings[j][1]+","+CurrentBookings[j][2]+","+CurrentBookings[j][3]+","+CurrentBookings[j][4]+","+CurrentBookings[j][5]);
			if (z==7)
				textField_7.setText(CurrentBookings[j][0]+","+CurrentBookings[j][1]+","+CurrentBookings[j][2]+","+CurrentBookings[j][3]+","+CurrentBookings[j][4]+","+CurrentBookings[j][5]);
			if (z==8)
				textField_8.setText(CurrentBookings[j][0]+","+CurrentBookings[j][1]+","+CurrentBookings[j][2]+","+CurrentBookings[j][3]+","+CurrentBookings[j][4]+","+CurrentBookings[j][5]);
			if (z>=9) {
				JOptionPane.showMessageDialog(null,"There are more than 9 trips booked,Displaying oldest booked trips","Too Many Trips",JOptionPane.INFORMATION_MESSAGE);
				break;
		}}
