...
public class ExternalTicketDetailsGUI {
	...
	ExternalTripGUI ET= new ExternalTripGUI();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ExternalTicketDetailsGUI window = new ExternalTicketDetailsGUI();
	 ...
	 */
	public ExternalTicketDetailsGUI() {
		initialize();
	}
	...
	private void initialize() {
		...
		if(ET.getType().trim().equals("External")) {
			textField.setText(VerifyLogin.ID);
			textField_1.setText(ExternalTripGUI.city);
			textField_2.setText(ExternalTripGUI.vehicle);
			textField_3.setText(ExternalTripGUI.way);
			textField_4.setText(ExternalTripGUI.type);
			textField_5.setText(ExternalTripGUI.stops);
			for(j=0;j<=i;j++) {
			if(CityDetails[6][0].trim().equals(ET.getCity())) {
			textField_6.setText(CityDetails[6][2]+""+"L.E");
			textField_7.setText(CityDetails[6][1]+""+"K.M");}
			if(CityDetails[7][0].trim().equals(ET.getCity())) {
				textField_6.setText(CityDetails[7][2]+""+"L.E");
				textField_7.setText(CityDetails[7][1]+""+"K.M");}
			if(CityDetails[8][0].trim().equals(ET.getCity())) {
				textField_6.setText(CityDetails[8][2]+""+"L.E");
				textField_7.setText(CityDetails[8][1]+""+"K.M");}
		}}	
